...
import { allTrips, travelStyles } from "~/constants";
...
const TripDetail = ({loaderData}: Route.ComponentProps ) => {
    ...
    const { name, duration, itinerary, groupType, budget, interests, estimatedPrice, description, bestTimeToVisit, weatherInfo, country, travelStyle } = tripData || {};
  ...
  return (
    <main className="travel-detail wrapper">
        ...
        <section className="container wrapper-md">
            ...
            <p className="text-sm md:text-lg font-normal text-dark-400 text-justify">{description}</p>
                        ...
                        <ul>
                            {dayPlan.activities.map((activity, index: number) => (
                                <li key={index}>
                                    ...
                                    <p className="flex-grow text-justify">{activity.description}</p>
                                </li>
                            ))}
                        </ul>
                    </li>
